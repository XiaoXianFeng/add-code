...
<html>
		...
		<c:if test="${not empty plan.message }">
			<div class="w3-panel w3-yellow">
			    <p><c:out value="${plan.message}"/></p>
					...
					<h4 align="center">杭州中科微电子有限公司</h4>
					 <hr> 
					<h4 align="center">生产计划通知书</h4>
	<table border="1" style="margin-left: auto;margin-right: auto; width:80%">	
		...
		<tr>
			...
			<td>日    期：</td>
			<td colspan="3"><fmt:formatDate value="${plan.createDate}" pattern="yyyy-MM-dd" /></td>
		</tr>
		<tr>
			<td >收件部门:</td>
			<td>
				<a href="#" class="editable" id="shoujian_department" data-type="text" data-pk="shoujian_department" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="输入收件部门">
					<c:out value="${plan.planItems['shoujian_department'].itemValue}"/>
				</a>
			</td>
		</tr>
		<tr>
