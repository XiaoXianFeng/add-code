...
<body style=" width: 100%;">
	...
	<table border="1" style="margin-left: auto;margin-right: auto; width:80%">	
		...
		<tr>
			...
			<td colspan="1" style="width:200px" align="left"><div style="width:200px; text-align:left;  word-break: break-all;"><a href="#" id="customer" data-type="text" data-pk="customer" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="输入客户名称">
			...
			<td colspan="1" style="width:200px" align="left"><div style="width:200px; text-align:left; word-break: break-all;"><a href="#" id="saleType" data-type="checklist" data-pk="saleType" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="选择销售"></a></div> 
				<script>
					$(function() {
						$('#saleType').editable({
		...
		<tr>
			<td colspan="1">文件编号:</td>
			<td colspan="1"><c:out value="${plan.notifyNo}"/></td>
			<td colspan="2">日    期：</td>
			<td colspan="1"><fmt:formatDate value="${plan.createDate}" pattern="yyyy-MM-dd" /></td>
		</tr>
		<tr>
